...
3. 文档的CRUD操作。
   ...
   ```JavaScript
   > // 向students集合插入文档
   > db.students.insert({stuid: 1001, name: 'Damon', age: 38})
   ...
   > // 查看所有文档
   > db.students.find()
   { "_id" : ObjectId("5b13c72e006ad854460ee70b"), "stuid" : 1001, "name" : "Damon", "age" : 38 }
   ...
   > // 查询name为“Damon”或者tel为“13022223333”的文档
   > db.students.find({'$or': [{name: 'Damon'}, {tel: '13022223333'}]}, {_id: 0, name: 1, tel: 1}).pretty()
   { "name" : "Damon", "tel" : "13566778899" }
   { "name" : "白元芳", "tel" : "13022223333" }
   > // 查询学生文档跳过第1条文档只查1条文档
...
'name_1'
>>> coll.insert_one({'stuid': int(1001), 'name': 'Damon', 'gender': True})
